...
const About = () => {
  ...
  const [counters, setCounters] = useState({ movies: 0, users: 0, bookings: 0 });
  ...
  const features = [
    {
      icon: <FaFilm />,
      title: "Latest Movies",
      description: "Browse and discover the newest blockbusters and indie films"
    },
    {
      icon: <FaTicketAlt />,
      title: "Easy Booking",
    ...
    },
    {
      ...
      description: "Find showtimes at theaters near you with detailed information"
    },
    {
      icon: <FaStar />,
          ...
          <div className="row">
            <div className="col-md-4 mb-4">
              <div className="stat-card">
                ...
                <div className="stat-number">{counters.movies.toLocaleString()}+</div>
            ...
            <div className="col-md-4 mb-4">
              <div className="stat-card">
                ...
                <div className="stat-number">{counters.bookings.toLocaleString()}+</div>
            ...
            <div className="col-lg-6 mb-4 mb-lg-0">
              <div className="mission-content">
                ...
                <p className="mission-text">
                  At CineBook, we believe that going to the movies should be effortless and enjoyable. 
                  Our mission is to revolutionize the way people discover, book, and experience cinema 
                  by providing a seamless, user-friendly platform that connects movie lovers with their 
                  favorite films.
                </p>
            ...
            <div className="col-lg-8">
              <div className="footer-content">
                ...
                <p className="footer-text">
                  Join thousands of movie enthusiasts who trust CineBook for their entertainment needs.
                </p>
                ...
                <p className="copyright">
                  © 2024 CineBook. All rights reserved. Made with <FaHeart className="heart-icon" /> for movie lovers.
                </p>
              </div>
            </div>
          </div>
